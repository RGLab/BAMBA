...
namespace model_bamba_ag_fc_grp_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bamba_ag_fc_grp_model");
    reader.add_event(161, 159, "end", "model_bamba_ag_fc_grp_model");
    return reader;
}

class model_bamba_ag_fc_grp_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> obs_to_t;
    ...
    vector_d y;
public:
    model_bamba_ag_fc_grp_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bamba_ag_fc_grp_model_namespace::model_bamba_ag_fc_grp_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<local_scalar_t__> omega_grp;
            ...
            vector<local_scalar_t__> omega_ag;
            ...
            vector<local_scalar_t__> omega_re;
            ...
            vector<local_scalar_t__> omega_t;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  mu_ag;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  mu_re;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  mu0;
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > soft_z(N, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(2))));
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> > mu_ar(T, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic> (static_cast<Eigen::VectorXd::Index>(N_ag),static_cast<Eigen::VectorXd::Index>(N_re))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bamba_ag_fc_grp_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        vars__.push_back(b_t);
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > z(N, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(2))));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(z, 
                            ...
                            softmax(get_base1(soft_z,n,"soft_z",1)), 
    ...
    static std::string model_name() {
        return "model_bamba_ag_fc_grp_model";
    }
...
namespace model_bamba_ag_fc_grp_sat_model_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_bamba_ag_fc_grp_sat_model");
    reader.add_event(180, 178, "end", "model_bamba_ag_fc_grp_sat_model");
    return reader;
}

class model_bamba_ag_fc_grp_sat_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> obs_to_t;
    ...
    vector_d y;
public:
    model_bamba_ag_fc_grp_sat_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bamba_ag_fc_grp_sat_model_namespace::model_bamba_ag_fc_grp_sat_model";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
        ...
        try {
            ...
            context__.validate_dims("data initialization", "N_sat", "int", context__.to_vec());
            N_sat = int(0);
            vals_i__ = context__.vals_i("N_sat");
            pos__ = 0;
            N_sat = vals_i__[pos__++];
            validate_non_negative_index("sat_ind", "N_sat", N_sat);
            context__.validate_dims("data initialization", "sat_ind", "int", context__.to_vec(N_sat));
            validate_non_negative_index("sat_ind", "N_sat", N_sat);
            sat_ind = std::vector<int>(N_sat,int(0));
            vals_i__ = context__.vals_i("sat_ind");
            pos__ = 0;
            size_t sat_ind_limit_0__ = N_sat;
            for (size_t i_0__ = 0; i_0__ < sat_ind_limit_0__; ++i_0__) {
                sat_ind[i_0__] = vals_i__[pos__++];
            }
            validate_non_negative_index("y", "N", N);
            context__.validate_dims("data initialization", "y", "vector_d", context__.to_vec(N));
            validate_non_negative_index("y", "N", N);
            ...
            check_greater_or_equal(function__,"N_sat",N_sat,0);
            for (int k0__ = 0; k0__ < N_sat; ++k0__) {
                check_greater_or_equal(function__,"sat_ind[k0__]",sat_ind[k0__],1);
            }
            // initialize data variables
        ...
        validate_non_negative_index("mu_re", "N_re", N_re);
            ...
            validate_non_negative_index("mu0", "T", T);
            num_params_r__ += T;
            validate_non_negative_index("delta_sat", "N_sat", N_sat);
            num_params_r__ += N_sat;
            ++num_params_r__;
            ++num_params_r__;
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    ~model_bamba_ag_fc_grp_sat_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("delta_sat")))
            throw std::runtime_error("variable delta_sat missing");
        vals_r__ = context__.vals_r("delta_sat");
        pos__ = 0U;
        validate_non_negative_index("delta_sat", "N_sat", N_sat);
        context__.validate_dims("initialization", "delta_sat", "vector_d", context__.to_vec(N_sat));
        vector_d delta_sat(static_cast<Eigen::VectorXd::Index>(N_sat));
        for (int j1__ = 0U; j1__ < N_sat; ++j1__)
            delta_sat(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_lb_unconstrain(0,delta_sat);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable delta_sat: ") + e.what());
        }

        if (!(context__.contains_r("alpha_sat")))
            throw std::runtime_error("variable alpha_sat missing");
        vals_r__ = context__.vals_r("alpha_sat");
        pos__ = 0U;
        context__.validate_dims("initialization", "alpha_sat", "double", context__.to_vec());
        double alpha_sat(0);
        alpha_sat = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,alpha_sat);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable alpha_sat: ") + e.what());
        }

        if (!(context__.contains_r("beta_sat")))
            throw std::runtime_error("variable beta_sat missing");
        vals_r__ = context__.vals_r("beta_sat");
        pos__ = 0U;
        context__.validate_dims("initialization", "beta_sat", "double", context__.to_vec());
        double beta_sat(0);
        beta_sat = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,beta_sat);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable beta_sat: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  delta_sat;
            (void) delta_sat;  // dummy to suppress unused var warning
            if (jacobian__)
                delta_sat = in__.vector_lb_constrain(0,N_sat,lp__);
            else
                delta_sat = in__.vector_lb_constrain(0,N_sat);

            local_scalar_t__ alpha_sat;
            (void) alpha_sat;  // dummy to suppress unused var warning
            if (jacobian__)
                alpha_sat = in__.scalar_lb_constrain(0,lp__);
            else
                alpha_sat = in__.scalar_lb_constrain(0);

            local_scalar_t__ beta_sat;
            (void) beta_sat;  // dummy to suppress unused var warning
            if (jacobian__)
                beta_sat = in__.scalar_lb_constrain(0,lp__);
            else
                beta_sat = in__.scalar_lb_constrain(0);
            ...
            stan::math::initialize(mu_ar, DUMMY_VAR__);
            stan::math::fill(mu_ar,DUMMY_VAR__);
            validate_non_negative_index("ystar", "N", N);
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  ystar(static_cast<Eigen::VectorXd::Index>(N));
            (void) ystar;  // dummy to suppress unused var warning

            stan::math::initialize(ystar, DUMMY_VAR__);
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), 
                            (stan::math::log((1 - (((get_base1(omega_grp,get_base1(obs_to_grp,n,"obs_to_grp",1),"omega_grp",1) * get_base1(omega_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),"omega_ag",1)) * get_base1(omega_re,get_base1(obs_to_re,n,"obs_to_re",1),"omega_re",1)) * get_base1(omega_t,get_base1(obs_to_t,n,"obs_to_t",1),"omega_t",1)))) + normal_log(get_base1(ystar,n,"ystar",1),get_base1(mu0,get_base1(obs_to_t,n,"obs_to_t",1),"mu0",1),get_base1(sigma,get_base1(obs_to_t,n,"obs_to_t",1),"sigma",1))), 
                            "assigning variable soft_z");
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), 
                            (stan::math::log((((get_base1(omega_grp,get_base1(obs_to_grp,n,"obs_to_grp",1),"omega_grp",1) * get_base1(omega_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),"omega_ag",1)) * get_base1(omega_re,get_base1(obs_to_re,n,"obs_to_re",1),"omega_re",1)) * get_base1(omega_t,get_base1(obs_to_t,n,"obs_to_t",1),"omega_t",1))) + normal_log(get_base1(ystar,n,"ystar",1),(get_base1(mu0,get_base1(obs_to_t,n,"obs_to_t",1),"mu0",1) + get_base1(get_base1(mu_ar,get_base1(obs_to_t,n,"obs_to_t",1),"mu_ar",1),get_base1(obs_to_ag,n,"obs_to_ag",1),get_base1(obs_to_re,n,"obs_to_re",1),"mu_ar",2)),get_base1(sigma,get_base1(obs_to_t,n,"obs_to_t",1),"sigma",1))), 
            ...
            for (int i0__ = 0; i0__ < N; ++i0__) {
                if (stan::math::is_uninitialized(ystar(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: ystar" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            ...
            lp_accum__.add(uniform_log<propto__>(alpha_re, 0, 1000));
            lp_accum__.add(uniform_log<propto__>(beta_re, 0, 1000));
            lp_accum__.add(uniform_log<propto__>(alpha_sat, 0, 1000));
            lp_accum__.add(uniform_log<propto__>(beta_sat, 0, 1000));
            lp_accum__.add(normal_log<propto__>(mu0, 0, 0.5));
            for (int n_a = 1; n_a <= N_ag; ++n_a) {
            ...
            lp_accum__.add(gamma_log<propto__>(delta_sat, alpha_sat, beta_sat));
            for (int n = 1; n <= N; ++n) {
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("lambda_t");
        names__.push_back("mu0");
        names__.push_back("delta_sat");
        names__.push_back("alpha_sat");
        names__.push_back("beta_sat");
        names__.push_back("a_grp");
        names__.push_back("b_grp");
        names__.push_back("a_ag");
        names__.push_back("b_ag");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bamba_ag_fc_grp_sat_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector<double> omega_grp;
        size_t dim_omega_grp_0__ = N_grp;
        ...
        double lambda_t = in__.scalar_lb_constrain(0.10000000000000001);
        vector_d mu0 = in__.vector_constrain(T);
        vector_d delta_sat = in__.vector_lb_constrain(0,N_sat);
        double alpha_sat = in__.scalar_lb_constrain(0);
        double beta_sat = in__.scalar_lb_constrain(0);
            for (int k_0__ = 0; k_0__ < N_grp; ++k_0__) {
            vars__.push_back(omega_grp[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < N_ag; ++k_0__) {
        ...
        vars__.push_back(lambda_t);
            ...
            for (int k_0__ = 0; k_0__ < N_sat; ++k_0__) {
            vars__.push_back(delta_sat[k_0__]);
            }
        vars__.push_back(alpha_sat);
        vars__.push_back(beta_sat);
    ...
    static std::string model_name() {
        return "model_bamba_ag_fc_grp_sat_model";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= N_sat; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "delta_sat" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        param_name_stream__ << "alpha_sat";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "beta_sat";
        param_names__.push_back(param_name_stream__.str());
        ...
        if (include_tparams__) {
            ...
            for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "ystar" << '.' << k_0__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
...
namespace model_bamba_ag_fc_model_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_bamba_ag_fc_model");
    reader.add_event(144, 142, "end", "model_bamba_ag_fc_model");
    return reader;
}

class model_bamba_ag_fc_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> obs_to_t;
    ...
    vector_d y;
public:
    model_bamba_ag_fc_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bamba_ag_fc_model_namespace::model_bamba_ag_fc_model";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), 
                            (stan::math::log((1 - ((get_base1(omega_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),"omega_ag",1) * get_base1(omega_re,get_base1(obs_to_re,n,"obs_to_re",1),"omega_re",1)) * get_base1(omega_t,get_base1(obs_to_t,n,"obs_to_t",1),"omega_t",1)))) + normal_log(get_base1(y,n,"y",1),get_base1(mu0,get_base1(obs_to_t,n,"obs_to_t",1),"mu0",1),get_base1(sigma,get_base1(obs_to_t,n,"obs_to_t",1),"sigma",1))), 
                            "assigning variable soft_z");
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), 
                            (stan::math::log(((get_base1(omega_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),"omega_ag",1) * get_base1(omega_re,get_base1(obs_to_re,n,"obs_to_re",1),"omega_re",1)) * get_base1(omega_t,get_base1(obs_to_t,n,"obs_to_t",1),"omega_t",1))) + normal_log(get_base1(y,n,"y",1),(get_base1(mu0,get_base1(obs_to_t,n,"obs_to_t",1),"mu0",1) + get_base1(get_base1(mu_ar,get_base1(obs_to_t,n,"obs_to_t",1),"mu_ar",1),get_base1(obs_to_ag,n,"obs_to_ag",1),get_base1(obs_to_re,n,"obs_to_re",1),"mu_ar",2)),get_base1(sigma,get_base1(obs_to_t,n,"obs_to_t",1),"sigma",1))), 
                            "assigning variable soft_z");
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bamba_ag_fc_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector<double> omega_ag;
        size_t dim_omega_ag_0__ = N_ag;
    ...
    static std::string model_name() {
        return "model_bamba_ag_fc_model";
    }
...
namespace model_bamba_ag_fc_sat_model_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_bamba_ag_fc_sat_model");
    reader.add_event(163, 161, "end", "model_bamba_ag_fc_sat_model");
    return reader;
}

class model_bamba_ag_fc_sat_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> obs_to_t;
    ...
    vector_d y;
public:
    model_bamba_ag_fc_sat_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bamba_ag_fc_sat_model_namespace::model_bamba_ag_fc_sat_model";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bamba_ag_fc_sat_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector<double> omega_ag;
        size_t dim_omega_ag_0__ = N_ag;
    ...
    static std::string model_name() {
        return "model_bamba_ag_fc_sat_model";
    }
...
namespace model_bamba_ag_grp_model_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_bamba_ag_grp_model");
    reader.add_event(124, 122, "end", "model_bamba_ag_grp_model");
    return reader;
}

class model_bamba_ag_grp_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> obs_to_t;
    ...
    vector_d y;
public:
    model_bamba_ag_grp_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bamba_ag_grp_model_namespace::model_bamba_ag_grp_model";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), 
                            (stan::math::log((1 - ((get_base1(omega_grp,get_base1(obs_to_grp,n,"obs_to_grp",1),"omega_grp",1) * get_base1(omega_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),"omega_ag",1)) * get_base1(omega_t,get_base1(obs_to_t,n,"obs_to_t",1),"omega_t",1)))) + normal_log(get_base1(y,n,"y",1),get_base1(mu0,get_base1(obs_to_t,n,"obs_to_t",1),"mu0",1),get_base1(sigma,get_base1(obs_to_t,n,"obs_to_t",1),"sigma",1))), 
                            "assigning variable soft_z");
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bamba_ag_grp_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector<double> omega_grp;
        size_t dim_omega_grp_0__ = N_grp;
    ...
    static std::string model_name() {
        return "model_bamba_ag_grp_model";
    }
...
namespace model_bamba_ag_grp_sat_model_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_bamba_ag_grp_sat_model");
    reader.add_event(143, 141, "end", "model_bamba_ag_grp_sat_model");
    return reader;
}

class model_bamba_ag_grp_sat_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> obs_to_t;
    ...
    vector_d y;
public:
    model_bamba_ag_grp_sat_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bamba_ag_grp_sat_model_namespace::model_bamba_ag_grp_sat_model";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bamba_ag_grp_sat_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector<double> omega_grp;
        size_t dim_omega_grp_0__ = N_grp;
    ...
    static std::string model_name() {
        return "model_bamba_ag_grp_sat_model";
    }
...
namespace model_bamba_ag_model_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_bamba_ag_model");
    reader.add_event(105, 103, "end", "model_bamba_ag_model");
    return reader;
}

class model_bamba_ag_model : public prob_grad {
private:
    int N;
    int T;
    vector<int> obs_to_t;
    ...
    vector_d y;
public:
    model_bamba_ag_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bamba_ag_model_namespace::model_bamba_ag_model";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), 
                            (stan::math::log((1 - (get_base1(omega_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),"omega_ag",1) * get_base1(omega_t,get_base1(obs_to_t,n,"obs_to_t",1),"omega_t",1)))) + normal_log(get_base1(y,n,"y",1),get_base1(mu0,get_base1(obs_to_t,n,"obs_to_t",1),"mu0",1),get_base1(sigma,get_base1(obs_to_t,n,"obs_to_t",1),"sigma",1))), 
                            "assigning variable soft_z");
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), 
                            (stan::math::log((get_base1(omega_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),"omega_ag",1) * get_base1(omega_t,get_base1(obs_to_t,n,"obs_to_t",1),"omega_t",1))) + normal_log(get_base1(y,n,"y",1),(get_base1(mu0,get_base1(obs_to_t,n,"obs_to_t",1),"mu0",1) + get_base1(mu_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),get_base1(obs_to_t,n,"obs_to_t",1),"mu_ag",1)),get_base1(sigma,get_base1(obs_to_t,n,"obs_to_t",1),"sigma",1))), 
                            "assigning variable soft_z");
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bamba_ag_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector<double> omega_ag;
        size_t dim_omega_ag_0__ = N_ag;
...
namespace model_bamba_ag_sat_model_namespace {
...
private:
    ...
    vector_d y;
public:
    model_bamba_ag_sat_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bamba_ag_sat_model_namespace::model_bamba_ag_sat_model";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), 
                            (stan::math::log((1 - (get_base1(omega_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),"omega_ag",1) * get_base1(omega_t,get_base1(obs_to_t,n,"obs_to_t",1),"omega_t",1)))) + normal_log(get_base1(ystar,n,"ystar",1),get_base1(mu0,get_base1(obs_to_t,n,"obs_to_t",1),"mu0",1),get_base1(sigma,get_base1(obs_to_t,n,"obs_to_t",1),"sigma",1))), 
                            "assigning variable soft_z");
                stan::model::assign(soft_z, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), 
                            (stan::math::log((get_base1(omega_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),"omega_ag",1) * get_base1(omega_t,get_base1(obs_to_t,n,"obs_to_t",1),"omega_t",1))) + normal_log(get_base1(ystar,n,"ystar",1),(get_base1(mu0,get_base1(obs_to_t,n,"obs_to_t",1),"mu0",1) + get_base1(mu_ag,get_base1(obs_to_ag,n,"obs_to_ag",1),get_base1(obs_to_t,n,"obs_to_t",1),"mu_ag",1)),get_base1(sigma,get_base1(obs_to_t,n,"obs_to_t",1),"sigma",1))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bamba_ag_sat_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector<double> omega_ag;
        size_t dim_omega_ag_0__ = N_ag;
    ...
    static std::string model_name() {
        return "model_bamba_ag_sat_model";
    }
